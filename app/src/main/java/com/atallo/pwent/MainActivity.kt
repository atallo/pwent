...
//                start()
        ...
        binding.toggleButton.isChecked = bridgeApplication.isServerConnected(statusKey = "server_status")
        ...
        binding.autoStartWithAndroid.isChecked = bridgeApplication.isServerConnected(statusKey = "set_reboot")
    }
